...
dependencies {
    ...
    implementation("androidx.navigation:navigation-compose:2.7.7")  // Compose导航组件
    ...
    implementation("com.patrykandpatrick.vico:compose-m3:1.13.1")  // Material 3支持
    ...
    implementation("com.squareup.okhttp3:logging-interceptor:4.12.0") // 用于日志
